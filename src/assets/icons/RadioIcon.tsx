...
export const RadioIcon = ({ size, checked, ...props }: RadioIconProps) => {
	return checked ? (
		<svg
			width={size}
			height={size}
		...
		>
			<g clipPath='url(#clip0_346_12709)'>
		...
		<svg
			...
			xmlns='http://www.w3.org/2000/svg'
		>
			<g clipPath='url(#clip0_346_12706)'>
